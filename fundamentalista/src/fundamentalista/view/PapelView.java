...
//		menu.add(createMenuItemVestuario());
	...
	private void preparar(List<Papel> papeis) {
		...
		data[papeis.size() + 1][3] = "M�DIA DIV.YIELD";
		data[papeis.size() + 1][4] = "M�DIA MRG EBIT";
		data[papeis.size() + 1][5] = "M�DIA LIQ. CORR.";
		data[papeis.size() + 1][6] = "M�DIA ROE";
		data[papeis.size() + 1][7] = "M�DIA M�DIA LIQ. 2MESES";
		data[papeis.size() + 1][8] = "M�DIA M�DIA CRESC.";
